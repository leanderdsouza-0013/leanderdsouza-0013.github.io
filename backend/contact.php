...
<head>
  ...
  <title>Contact - Leander Chris Dsouza</title>
...
<nav class="navbar" role="navigation" aria-label="Main navigation">
  ...
  <div class="main-content">
    <div class="container">
	  ...
	  <br>
      <p><strong>LinkedIn:</strong> <a ng-href="{{ contact.linkedin }}" target="_blank">{{ contact.linkedin }}</a></p>
	  <br>
      <p><strong>GitHub:</strong> <a ng-href="{{ contact.github }}" target="_blank">{{ contact.github }}</a></p>
    </div>
  </div>
